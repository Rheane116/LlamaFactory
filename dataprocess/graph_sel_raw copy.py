...
if __name__ == "__main__":
    ...
    G = {
            "entities": {"5-ASA": "Drug", "fever": "Adverse-Effect", "mesalamine": "Drug", "prednisone": "Drug", "worsening respiratory distress": "Adverse-Effect"}, "relations": [["fever", "adverse_effect", "5-ASA"], ["fever", "adverse_effect", "mesalamine"], ["fever", "adverse_effect", "prednisone"], ["worsening respiratory distress", "adverse_effect", "5-ASA"], ["worsening respiratory distress", "adverse_effect", "mesalamine"], ["worsening respiratory distress", "adverse_effect", "prednisone"]]}
