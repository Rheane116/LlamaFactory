...
from .metric import ComputeAccuracy, ComputeF1, ComputeSimilarity, eval_logit_processor
...
def run_sft(
    ...
    if training_args.predict_with_generate and finetuning_args.compute_f1:
        metric_module["compute_metrics"] = ComputeF1(tokenizer=tokenizer)
